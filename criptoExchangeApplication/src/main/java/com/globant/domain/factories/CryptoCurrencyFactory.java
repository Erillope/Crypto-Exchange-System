...
public class CryptoCurrencyFactory {
    ...
    public Bitcoin createBitcoin(BigDecimal amount){
        return new Bitcoin(amount);
    }
    
    public Ethereum createEthereum(BigDecimal amount){
        return new Ethereum(amount);
    }
    
    public Ripple createRiplle(BigDecimal amount){
        return new Ripple(amount);
    }
    
    public CryptoCurrency createCryptoCurrency(CryptoCurrencyName cryptoName, BigDecimal amount){
